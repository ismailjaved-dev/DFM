...
const ServiceCard = () => {
  const data = [
    {
      title: "Scale",
      desc: "Cutting-edge technology that enables complete flexibility in how we operate.",
      icon: "/scaleIcon.svg",
    },
    {
      title: "Technology",
    ...
    {
      title: "Consistency",
      desc: "Delivering unrivalled consistency of flow, spreads, and customer service.",
      icon: "/consistencyIcon.svg",
    },
    {
      title: "Flexibility",
      desc: "Flexibility in price feeds and routing, delivers unparalleled consistency of flow and spreads.",
      icon: "/flexibilityIcon.svg",
    },
  ];

  return (
    <section className="relative w-full grid">
      <section className="fluid-container relative z-20 p-5 lg:pt-0">
          ...
          <div className="grid sm:grid-cols-2 gap-x-[0.9375rem] gap-y-[0.625rem]">
            {data.map((res, index) => {
              return (
                <div
                  key={index}
                  className="bg-[#080C15]/80 p-10 rounded-[20px] outline outline-white/5 outline-1"
                >
      ...
      <Image
        ...
        fill
        alt=""
        className="starImg justify-self-end"
      />
    </section>
  );
};
